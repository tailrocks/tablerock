...
- 584 — [Native dirty-tab close XCUITest](delivery/584-native-dirty-tab-close-xcuitest.md)
- 585 — [Structured JSON number identity](delivery/585-structured-json-number-identity.md)
- 586 — [PageV1 pre-loop cardinality validation](delivery/586-pagev1-preloop-cardinality.md)
...
- 598 — [Concurrent cancellation transport and stream drain](delivery/598-concurrent-cancel-stream-drain.md)
- 599 — [PostgreSQL activity fixture container host](delivery/599-postgres-activity-container-host.md)
...
- 617 — [Native ordered sort headers](delivery/617-native-ordered-sort-headers.md)
- 618 — [Native direct control activation](delivery/618-native-direct-control-activation.md)
- 619 — [PTY lifecycle scheduler isolation](delivery/619-pty-lifecycle-scheduler-isolation.md)
...
- 642 — [Native typed query parameters](delivery/642-native-query-parameters.md)
...
- 683 — [Native Bridge facade ownership](delivery/683-native-bridge-facade-ownership.md)
- 684 — [Native fixture projection boundary](delivery/684-native-fixture-projection-boundary.md)
- 685 — [Native presentation store extraction](delivery/685-native-presentation-store-extraction.md)
...
- 690 — [Native SQL file workflow extraction](delivery/690-native-sql-file-workflow-extraction.md)
- 691 — [Native history and saved-query workflow extraction](delivery/691-native-library-workflow-extraction.md)
...
- 696 — [Native editor workflow extraction](delivery/696-native-editor-workflow-extraction.md)
- 697 — [Native safety workflow extraction](delivery/697-native-safety-workflow-extraction.md)
- 698 — [Native library-sheet extraction](delivery/698-native-library-sheet-extraction.md)
...
- 703 — [Native catalog-pane extraction](delivery/703-native-catalog-pane-extraction.md)
- 704 — [Native workbench-chrome extraction](delivery/704-native-workbench-chrome-extraction.md)
- 705 — [Native query-workspace extraction](delivery/705-native-query-workspace-extraction.md)
- 706 — [Native object-workspace extraction](delivery/706-native-object-workspace-extraction.md)
...
- 714 — [Native Redis-sheet extraction](delivery/714-native-redis-sheet-extraction.md)
- 715 — [Native toolbar extraction](delivery/715-native-toolbar-extraction.md)
- 716 — [Native settings extraction](delivery/716-native-settings-extraction.md)
- 717 — [Native workspace-tab extraction](delivery/717-native-workspace-tab-extraction.md)
- 718 — [Native object-surface extraction](delivery/718-native-object-surface-extraction.md)
