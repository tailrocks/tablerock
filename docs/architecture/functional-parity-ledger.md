...
| Filtering | Core | Filter bar with typed per-column conditions plus a raw-WHERE mode; clearly labeled resident-page quick filter; saved presets later | Parameterized filters + page-local (223–225); named presets (306–310); visual chip bar above grid (evidence 349) |
