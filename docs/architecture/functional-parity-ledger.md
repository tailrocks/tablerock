...
| Sorting | Core | Server sort for table browsing, explicit provenance, multi-column order, no unsafe SQL concatenation | Phase 5 `BrowsePlan` + CycleSort (223–225); PushSort/PopSort multi-key + sort chip bar (evidence 370); SortInv/SortRot/Sort1 (418–420); hostile identifier suite in browse_plan tests |
