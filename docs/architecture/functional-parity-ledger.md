...
| Capability | Status | TableRock requirement | Acceptance evidence |
|---|---|---|---|
| Virtualized grid | Core | Render only resident rows/columns; stable two-axis navigation and placeholders; no I/O from render | VirtualGrid + DataGridModel (211–214); resident-scroll no-I/O; million-row totals + resident window unit proof (evidence 355); PgUp/PgDn page jump (evidence 467); CI frame-time microbench optional |
