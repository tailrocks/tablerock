...
| Object tabs | Core | Preview/pinned/durable object tabs with independent context and state; the same object may open in several tabs with independent sort/filter/columns/staged changes | Restore, close-policy, and multi-instance independence tests; CloseOthers (401); CloseLeft/CloseRight (evidence 428); CloseAll (evidence 434); NextDirty/PrevDirty (evidence 496) |
