...
| Type-specific editors | Parity | Bool, number, temporal, enum, JSON, bytes, array/map/tuple, and explicit unknown fallback | Paste + heuristics (230); TogBool/SetNull; Today/Now (346); Day± (365); Num± (351); FmtJson/CmpJson (353); enum picker optional |
