...
| Type-specific editors | Parity | Bool, number, temporal, enum, JSON, bytes, array/map/tuple, and explicit unknown fallback | Paste + heuristics (230); TogBool/SetNull; Today/Now (346); Yest/Tomor (evidence 482); Day± (365); Mon±/PickDate (369); Year± (evidence 481); CancelEd/CommitEd/RestoreEd palette (evidence 483–484); Num± (351); FmtJson/CmpJson (353); enum picker optional |
