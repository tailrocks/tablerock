...
| Column controls | Parity | Show/hide, reorder, width, fit, format, one-action reset, and stable per-table preferences | Phase 5 toggle/reset + per-table layout persistence (evidence 225); reorder/resize interaction on VirtualGrid still open |
