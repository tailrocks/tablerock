...
| Row/value inspector | Core | Full typed values, raw bytes/hex, JSON text/tree, metadata, and stale state | Phase 4 inspector panel text/hex/metadata/stale (evidence 213); large/binary/invalid JSON tree depth remains open |
