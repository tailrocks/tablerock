...
| Selection/copy | Parity | Cell/range/row selection and safe TSV/CSV/JSON/Markdown/SQL-INSERT/SQL-UPDATE projections; INSERT/UPDATE require base-table identity facts | Phase 5 six-format pure formatters + OSC 52 (224); CopyCell/hex/row TSV (354–355); row CSV/JSON/MD (evidence 375); identity-gated SQL INSERT/UPDATE tests |
