...
| Find/replace regex | [`regex`](https://github.com/rust-lang/regex) | 1.13.1 | MIT OR Apache-2.0 | core shared find/replace engine for TUI (modes match native TR-SCR-049); no untrusted network patterns |
