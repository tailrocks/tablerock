...
server-replacement resubscription, restricted-channel denial, credential
revocation during active Pub/Sub, DNS changes, strict RESP2 pre-decode allocation bounds,
