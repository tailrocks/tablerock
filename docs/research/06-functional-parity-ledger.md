...
| Phase 2 — Redis timeout/reconnect | [`143-phase-2-redis-timeout-reconnect.md`](143-phase-2-redis-timeout-reconnect.md) | Reviewed 2026-07-17. Redis 7.4.9/8.8.0 under RESP2/RESP3 prove bounded response timeout, confirmed-drop future-call reconnect, logical DB retention, and disposable blocking client identity. Redis connectivity remains open until server-restart/DNS, TLS/authentication, Pub/Sub, write-ambiguity, service/UI, and remaining matrix gates pass. |
