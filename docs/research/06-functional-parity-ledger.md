...
| Typed display | Core | Distinguish NULL, empty, whitespace, zero, false, bytes, structured containers, unknown, invalid, and truncated values | The Phase 2 owned-value unit contract covers null/empty/whitespace/zero/false/bytes/structured/unknown/invalid/truncated distinctions; real ClickHouse 25.8/26.3 LTS fixtures now prove booleans, all scalar integer widths through 256 bits, Decimal256, floats, temporal types, UUID/IP, enums, low-cardinality text, nullable text, binary, and bounded unknown fallback; PostgreSQL/Redis breadth and ClickHouse container decoding remain required |
