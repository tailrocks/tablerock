...
and research 182 promotes named composites and anonymous records with ordered
...
- record raw preservation established the safe precursor subsequently replaced
  by the structured decoder in research 182;
...
unbounded field remains open. JSON/JSONB projection is closed by research 168,
numeric decoding by
...
research 180, and composite projection by research 182.
