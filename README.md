...
all T1 neutral Tree, Form, and SplitPane prerequisites are verified; the
executable shell remains. Product name, package namespace, and legal clearance
remain subject to final review before public release.
