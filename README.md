...
verified. Render-authorized mouse/paste/focus routing is implemented. Its PTY
paths, returned-error/panic PTY paths, and typed engine overflow/resync policy
