...
- **IN PROGRESS (2026-07-19): native connection workflows (evidence 512–518), history/retention (519–520), saved queries (521), SQL files (522), typed intent bridge (523), query tabs (524), and read-only preview/pinned object tabs (525) landed; advanced object state, multi-window restoration, and remaining screens continue**
- **Priority**: P3
- **Effort**: L
- **Risk**: MED
