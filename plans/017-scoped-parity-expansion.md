...
- [x] Connect-path SSH auto-wrap + session-owned tunnel (evidence 266; TUI SSH section residual)
...
- SSH agent auth, encrypted private-key passphrase, TUI connection editor SSH section
