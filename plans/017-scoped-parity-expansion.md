...
- [x] SSH known_hosts fail-closed (evidence 261; agent/key + profile wiring residual)
...
- SSH agent/key auth, profile aggregate + connect-path wiring, multi-engine matrix
