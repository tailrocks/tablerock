...
fn render_actions(model: &Model, frame: &mut Frame<'_>, area: Rect, geometry: &mut ShellGeometry) {
    ...
    let first_dirty = action_label(model, ActionId::FirstDirtyTab, "FirstDirty");
    let last_dirty = action_label(model, ActionId::LastDirtyTab, "LastDirty");
    ...
    let filt_promote = action_label(model, ActionId::PromoteLastFilter, "PromoFilt");
    let filt_demote = action_label(model, ActionId::DemoteFirstFilter, "DemoFilt");
    ...
    let filt_nlike = action_label(model, ActionId::FilterNotLike, "NLike");
    let filt_nilike = action_label(model, ActionId::FilterINotLike, "NILike");
    ...
    let filt_instarts = action_label(model, ActionId::FilterINotStartsWith, "INStarts");
    let filt_inends = action_label(model, ActionId::FilterINotEndsWith, "INEnds");
    ...
    let go_first_staged = action_label(model, ActionId::GoToFirstStaged, "FirstStg");
    let go_last_staged = action_label(model, ActionId::GoToLastStaged, "LastStg");
    ...
    let commit_edit = action_label(model, ActionId::CommitCellEdit, "CommitEd");
    ...
    let copy_stg_st = action_label(model, ActionId::CopyStagedStatus, "CopyStgSt");
    ...
    let copy_cols_q = action_label(model, ActionId::CopyColumnIdents, "CopyColsQ");
    ...
    let copy_quick_f = action_label(model, ActionId::CopyQuickFilter, "CopyPgF");
    let copy_col_cnt = action_label(model, ActionId::CopyColumnCounts, "CopyColN#");
    ...
    let copy_schema_q = action_label(model, ActionId::CopySchemaIdent, "CopySchQ");
    let copy_bare = action_label(model, ActionId::CopyBareTable, "CopyTblN");
    let copy_bare_q = action_label(model, ActionId::CopyBareTableIdent, "CopyTblNQ");
    ...
    let copy_sel_where = action_label(model, ActionId::CopySelectWhereSql, "CopySelW");
    ...
    let copy_ins_load = action_label(model, ActionId::CopyInsertLoadedSql, "CopyInsL");
    let copy_ctx_sch = action_label(model, ActionId::CopyContextSchema, "CopyCtxSch");
    let copy_ctx_sch_q = action_label(model, ActionId::CopyContextSchemaIdent, "CopyCtxSchQ");
    ...
    let close_all_prev = action_label(model, ActionId::CloseAllPreviewTabs, "ClosePrevs");
    ...
    let copy_prev_tabs = action_label(model, ActionId::CopyPreviewTabTitles, "CopyPrevT");
        ...
        if model.password_prompt().is_some() || model.confirm().is_some() {
            ...
            match model.screen() {
                ...
                crate::Screen::Workbench => vec![
                    ...
                    Action {
                        id: ActionId::FirstDirtyTab,
                        label: first_dirty.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                        id: ActionId::LastDirtyTab,
                        label: last_dirty.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                    ...
                    Action {
                        id: ActionId::PromoteLastFilter,
                        label: filt_promote.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                        id: ActionId::DemoteFirstFilter,
                        label: filt_demote.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                    ...
                    Action {
                        id: ActionId::FilterNotLike,
                        label: filt_nlike.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                        id: ActionId::FilterINotLike,
                        label: filt_nilike.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                    ...
                    Action {
                        id: ActionId::FilterIStartsWith,
                        label: filt_istarts.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                    ...
                    Action {
                        id: ActionId::FilterINotStartsWith,
                        label: filt_instarts.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                        id: ActionId::FilterINotEndsWith,
                        label: filt_inends.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                    ...
                    Action {
                        id: ActionId::PromoteSort,
                        label: promote_sort.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                        id: ActionId::InvertAllSort,
                        label: inv_all_sort.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                    ...
                    Action {
                        id: ActionId::GoToFirstStaged,
                        label: go_first_staged.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                        id: ActionId::GoToLastStaged,
                        label: go_last_staged.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                    ...
                    Action {
                        id: ActionId::ResetColumnWidths,
                        label: col_rst_w.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                        id: ActionId::EqualizeColumnWidths,
                        label: col_eq_w.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                    ...
                    Action {
                        id: ActionId::CommitCellEdit,
                        label: commit_edit.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                        id: ActionId::RestoreCellEdit,
                        label: restore_edit.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                        id: ActionId::CopyCellEditBuffer,
                        label: copy_edit_buf.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                    ...
                    Action {
                        id: ActionId::CopyStagedStatus,
                        label: copy_stg_st.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                    ...
                    Action {
                        id: ActionId::CopyColumnIdents,
                        label: copy_cols_q.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                    ...
                    Action {
                        id: ActionId::CopyColumnName,
                        label: copy_col_name.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                    ...
                    Action {
                        id: ActionId::CopyQuickFilter,
                        label: copy_quick_f.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                        id: ActionId::CopyColumnCounts,
                        label: copy_col_cnt.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                        id: ActionId::CopyQueryId,
                        label: copy_qid.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                        id: ActionId::CopyServerProgress,
                        label: copy_progress.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                    ...
                    Action {
                        id: ActionId::CopySessionId,
                        label: copy_sess.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                        id: ActionId::CopyEngineLabel,
                        label: copy_eng.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                    ...
                    Action {
                        id: ActionId::CopySchema,
                        label: copy_schema.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                        id: ActionId::CopySchemaIdent,
                        label: copy_schema_q.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                    ...
                    Action {
                        id: ActionId::CopyBareTableIdent,
                        label: copy_bare_q.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                    ...
                    Action {
                        id: ActionId::CopySelectWhereSql,
                        label: copy_sel_where.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                        id: ActionId::CopyCountSql,
                        label: copy_count.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                        id: ActionId::CopyCountWhereSql,
                        label: copy_count_w.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                    ...
                    Action {
                        id: ActionId::CopyInsertLoadedSql,
                        label: copy_ins_load.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                    ...
                    Action {
                        id: ActionId::CopyContextSchemaIdent,
                        label: copy_ctx_sch_q.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                    ...
                    Action {
                        id: ActionId::CopyPkIdents,
                        label: copy_pk_q.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                    ...
                    Action {
                        id: ActionId::CloseAllPreviewTabs,
                        label: close_all_prev.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                    ...
                    Action {
                        id: ActionId::CopyActiveTabTitle,
                        label: copy_tab_title.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
                    ...
                    Action {
                        id: ActionId::CopyPreviewTabTitles,
                        label: copy_prev_tabs.as_str(),
                        enabled: true,
                        style: None,
                    },
                    Action {
