...
product: 1Password/Keychain/env sources. URL import landed later (evidence 289);
reconnect auto re-dispatch + delayed sleep (evidence 332). Temporary Connect,
save, Test without save, prompt-on-connect fail-closed, Remove confirm, and
TermRock Form/Tree are proven on trunk.
