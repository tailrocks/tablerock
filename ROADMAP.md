...
**Partial→mostly complete (evidence 245–246, 306–307):** atomic file export,
...
persist (schema 13) + TUI SaveFilt/LoadFilt + connect-path load, manual
reconnect policy. Residual: multi-named preset picker UI.
