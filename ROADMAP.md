...
**Partial→mostly complete (evidence 245–246, 306):** atomic file export,
...
persist (schema 13), manual reconnect policy. Residual: TUI load/save
wiring for filter library on connect/upsert.
